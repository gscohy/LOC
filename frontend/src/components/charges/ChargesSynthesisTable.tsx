      ...
      <div className="overflow-x-auto">
        <table className="min-w-full">
          <thead className="bg-gray-50">
            <tr>
              <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider sticky left-0 bg-gray-50 min-w-64">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {Object.entries(synthesisData).map(([bienId, bienData]) => (
              <tr key={bienId} className="hover:bg-gray-50">
                <td className="px-4 py-3 sticky left-0 bg-white border-r border-gray-200 min-w-64">
                  <div className="max-w-60">
                    <div className="font-medium text-gray-900 text-sm truncate" title={bienData.bien.adresse}>
                      {bienData.bien.adresse}
                    </div>
                    <div className="text-gray-500 text-xs truncate" title={bienData.bien.ville}>
                      {bienData.bien.ville}
                    </div>
                  </div>
                </td>
          ...
          <tfoot className="bg-gray-100">
            <tr>
              <td className="px-4 py-3 font-bold text-gray-900 sticky left-0 bg-gray-100 border-r border-gray-300 min-w-64">
                Total mensuel
              </td>
              {Array.from({ length: 12 }, (_, index) => {
                const month = index + 1;
